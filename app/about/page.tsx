          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <ScrollReveal>
              ...
              <p className="text-steel-400 leading-relaxed mb-4">
                Ovweta Global Limited is a 100% Nigerian-owned company incorporated and registered with the Corporate Affairs Commission (RC: 1524805), headquartered at No. 17A Chikwe Street, Rumukwurusitiku, Port Harcourt, Rivers State.
              </p>
              <p className="text-steel-400 leading-relaxed mb-4">
